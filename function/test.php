    ...
    <div class="row" id="sum-row">
        <div class="col">
            <form action="" id="sum-form-1" class="sum-form">
                <input type="hidden" name="content" id="input-sum-form-1" value="">
        ...
        <div class="col">
            <form action="" id="sum-form-2" class="sum-form">
                <input type="hidden" name="content" id="input-sum-form-2" value="">
        ...
        <div class="col">
            <form action="" id="sum-form-3" class="sum-form">
                <input type="hidden" name="content" id="input-sum-form-3" value="">
