            ...
            if (isset($data->items) && !empty($data->items)) {
                ...
                if (!empty($firstTenResults)) {
                    ...
                    foreach ($firstTenResults as $result) {
                        echo '<tr>';
                        echo "<td class='col-2 link-column'><a href='$result->link' target='_blank'>$result->link</a></td>";
                        ...
                        echo '<input type="submit" value="Get Content" class="btn btn-primary btn-show-form" data-form-id="' . $buttonCount . '">';
                        echo '</form>';

                        // Nút tóm tắt
                        echo "<br><br><button class='btn btn-primary btn-sum-form' id='btn-sum-form-$buttonCount' sum-form-id='$buttonCount' style=''>Summarize</button>";
                        echo "</td>";
