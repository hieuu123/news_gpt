...
<?php // sqltest.php
          ...
          ORDER BY post_id ASC;";
                ...
                if (
                  ...
                  $stmt = $conn->prepare("UPDATE `posts` SET `title` = ?, `content` = ?, `user_id` = ?, `category_id` = ?, `image` = ? WHERE `post_id` = ?");

                  // Bind the values to the statement
                  $stmt->bind_param("sssisi", $title, $content, $user_id, $category_id, $image, $post_id);
