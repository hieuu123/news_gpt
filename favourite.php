...
<body>
    ...
    <body>
        <div class="container c">
            <h2>Danh sách yêu thích của người dùng</h2>
            <?php
            if (isset($_SESSION['username'])) {
                $username = $_SESSION['username'];
                $query = "SELECT username, title, content, favorite.post_id FROM `favorite` INNER join `posts` on favorite.post_id = posts.post_id INNER JOIN `users` on favorite.user_id = users.user_id where username = '$username';";
