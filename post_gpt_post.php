    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-10">
          ...
          ORDER BY user_id ASC;";
                    ...
                    <label for="content">Content</label><br><textarea id="content" name="content" rows="8" cols="50">'.$gpt_get.'</textarea> <br>
                    <label for="user_image">Ảnh cho bài báo</label><br>
                    <input type="file" name="user_image" id="user_image" accept="image/*" multiple onchange="change()"><br>
                    ...
                    height: 50px;">';
                            ...
                            echo "Vui lòng sử dụng công cụ sáng tạo nội dung.<br>";
                            echo '<a href="post_gpt.php"><div class ="mybtn" style="text-align:center;">Công cụ sáng tạo nội dung</div></a>';
                            echo '<a href="post.php"><div class ="mybtn" style="text-align:center;">Viết bài thủ công</div></a>';
                        }
                        ?>
                </div>
            </div>
