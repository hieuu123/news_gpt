...
<body>
    ...
    <form action="post_gpt_post.php" style="display: none;" method="post">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-10">
          ...
          ORDER BY user_id ASC;";
                    ...
                    <label for="content">Content</label><br><textarea name="content" rows="8" cols="50">'.$gpt_get.'</textarea> <br>
