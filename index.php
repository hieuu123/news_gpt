                        ...
                        <!--<div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><a href="detail_M.php">Get the Illusion of Fuller Lashes by “Mascng.”</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            <span class="color2">Sports</span>
                                            <h4><h4><a href="detail_M.php">Get the Illusion of Fuller Lashes by “Mascng.”</a></h4></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><a href="detail_M.php"> Welcome To The Best Model Winner Contest</a></h4>
                                        </div>
                                    </div>
                                </div> -->
                            </div>
                        ...
                        <div class="weekly-news-active dot-style d-flex dot-style">
                            ...
                            <div class='weekly-single'>
                                <div class='weekly-img'>
                                    <img src='assets/img/news/weeklyNews2.jpg' alt='hinh anh nay moi chen'>
                                </div>
                        ...
                        <div class="properties__button">
                            ...
                            <nav>                                                                     
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Giải trí</a>
                                    ...
                                    <a class="nav-item nav-link" id="nav-Sports" data-toggle="tab" href="#nav-nav-Sport" role="tab" aria-controls="nav-contact" aria-selected="false">Sức khỏe</a>
                                    <a class="nav-item nav-link" id="nav-technology" data-toggle="tab" href="#nav-techno" role="tab" aria-controls="nav-contact" aria-selected="false">Du lịch</a>
                                </div>
                            </nav>
                            <!--End Nav Button  -->
                        </div>
